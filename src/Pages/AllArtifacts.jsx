...
import { FaEye, FaHistory, FaCalendarAlt, FaMapMarkerAlt } from 'react-icons/fa';
        ...
        <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="text-center mb-12">
                    <h1 className="text-4xl font-bold text-gray-900 mb-4">Artifact Collection</h1>
                ...
                {artifacts.length === 0 ? (
                    <div className="text-center py-16 bg-white rounded-xl shadow-sm">
                        <p className="text-gray-500 text-lg">No artifacts found in the collection</p>
                    </div>
                ) : (
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
                        {artifacts.map((artifact) => (
                            <div key={artifact._id} className="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
                                {/* Artifact Image */}
                                ...
                                {/* Artifact Info */}
                                <div className="p-6">
                                    <h2 className="text-xl font-bold text-gray-900 mb-2 line-clamp-1">{artifact.name}</h2>
                                    ...
                                    <div className="space-y-3 mb-4">
                                        ...
                                        <div className="flex items-center text-gray-600">
                                            ...
                                            <span className="text-sm line-clamp-1">{artifact.presentLocation}</span>
                                        </div>
                                    </div>
